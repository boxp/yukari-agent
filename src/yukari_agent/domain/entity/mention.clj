...
(s/def ::attachment (s/keys :req-un [:attachment/text :attachment/color :attachment/fields]))

(s/def :mention/type keyword?)
...
(s/def ::mention (s/keys :req-un [:mention/type :mention/for-me? :mention/from-me? :mention/channel-id :mention/text :mention/timestamp :mention/attachments :mention/username]))
